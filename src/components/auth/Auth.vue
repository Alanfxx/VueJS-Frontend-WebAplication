    ...
    <div class="auth-modal">
      ...
      <div role="group" style="width: 100%; margin-bottom: 20px;">
        <b-form-input
          ...
          @keyup.enter="signin"
        ></b-form-input>
        <b-form-invalid-feedback id="input-live-feedback">Digite um email válido</b-form-invalid-feedback>
      </div>
      <!-- Input senha -->
      <div role="group" style="width: 100%; margin-bottom: 20px;">
        <b-form-input
          ...
          @keyup.enter="signin"
        ></b-form-input>
        <b-form-invalid-feedback id="input-live-feedback2">Digite uma senha válida</b-form-invalid-feedback>
      </div>
      <!-- Botão entrar -->
      <b-button
        id="bt1"
        ...
        style="width: 100%"
      >
        <b-spinner small type="grow" v-show="showLoading"></b-spinner>
        {{showLoading ? ' Verificando..' : 'Entrar'}}
      </b-button>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    signin() {
      ...
      axios
        ...
        .catch(e => {
          this.authToast(
            e.response ? e.response.data : "Você ta sem internet",
            "primary"
          );
